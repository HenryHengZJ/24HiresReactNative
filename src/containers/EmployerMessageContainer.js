...
class EmployerMessageContainer extends Component {
  ...
  fetchData = () => {
    ...
    var url = apis.GETChatRoom_BASEURL + "userid=" + userid + "&limit=" + loadlimit + "&userrole=employer";
...
export default connect(mapStateToProps)(EmployerMessageContainer);
