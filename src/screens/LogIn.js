    ...
    this.authFirebaseListener = firebase.auth().onAuthStateChanged((user) => {
      if (user) {
        ...
        if(!user.emailVerified) {
            ...
            axios.get(jwturl)
              .then((response) => {
                ...
                this.setState({ 
                  ...
                  this.checkNewUser(user, navigation);
          ...
          this.setState({ showNotification: true, loadingVisible: false, errormsg: "User's email not verified" });
        }
      } 
        ...
        <View style={styles.scrollViewWrapper}>
          <ScrollView 
            ...
            <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
              <TouchableOpacity 
                onPress={this.onCreateAccountPress.bind(this, this.props.navigation)}
